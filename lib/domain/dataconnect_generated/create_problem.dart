...
class CreateProblemVariablesBuilder {
  ...
  Deserializer<CreateProblemData> dataDeserializer = (dynamic json) =>
      CreateProblemData.fromJson(jsonDecode(json));
  Serializer<CreateProblemVariables> varsSerializer =
      (CreateProblemVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<CreateProblemData, CreateProblemVariables> ref() {
    CreateProblemVariables vars = CreateProblemVariables(
      title: title,
      detail: detail,
      lat: lat,
      lng: lng,
...
class CreateProblemProblemInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateProblemProblemInsert otherTyped =
        other as CreateProblemProblemInsert;
  ...
  CreateProblemProblemInsert({required this.problemId});
}
...
class CreateProblemData {
  ...
  CreateProblemData.fromJson(dynamic json)
    : problem_insert = CreateProblemProblemInsert.fromJson(
        json['problem_insert'],
      );
  @override
  bool operator ==(Object other) {
  ...
  CreateProblemData({required this.problem_insert});
}
