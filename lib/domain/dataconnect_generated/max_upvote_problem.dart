...
class MaxUpvoteProblemVariablesBuilder {
  
  final FirebaseDataConnect _dataConnect;
  MaxUpvoteProblemVariablesBuilder(this._dataConnect, );
  Deserializer<MaxUpvoteProblemData> dataDeserializer = (dynamic json)  => MaxUpvoteProblemData.fromJson(jsonDecode(json));
  
  Future<QueryResult<MaxUpvoteProblemData, void>> execute() {
    return ref().execute();
  }

  QueryRef<MaxUpvoteProblemData, void> ref() {
    
    return _dataConnect.query("MaxUpvoteProblem", dataDeserializer, emptySerializer, null);
  }
}

@immutable
class MaxUpvoteProblemProblems {
  final String problemId;
  final MaxUpvoteProblemProblemsReporter reporter;
  final String title;
  final String detail;
  final String locationName;
  final MaxUpvoteProblemProblemsProblemType problemType;
  final MaxUpvoteProblemProblemsCurrentTags currentTags;
  final Timestamp createdAt;
  final double problemLat;
  final double problemLng;
  final int upvoteCount;
  final List<MaxUpvoteProblemProblemsUserUpvotesOnProblem> userUpvotes_on_problem;
  final List<MaxUpvoteProblemProblemsProblemImagesOnProblem> problemImages_on_problem;
  MaxUpvoteProblemProblems.fromJson(dynamic json):
  
  problemId = nativeFromJson<String>(json['problemId']),
  reporter = MaxUpvoteProblemProblemsReporter.fromJson(json['reporter']),
  title = nativeFromJson<String>(json['title']),
  detail = nativeFromJson<String>(json['detail']),
  locationName = nativeFromJson<String>(json['locationName']),
  problemType = MaxUpvoteProblemProblemsProblemType.fromJson(json['problemType']),
  currentTags = MaxUpvoteProblemProblemsCurrentTags.fromJson(json['currentTags']),
  ...
  userUpvotes_on_problem = (json['userUpvotes_on_problem'] as List<dynamic>)
        .map((e) => MaxUpvoteProblemProblemsUserUpvotesOnProblem.fromJson(e))
        .toList(),
  problemImages_on_problem = (json['problemImages_on_problem'] as List<dynamic>)
        .map((e) => MaxUpvoteProblemProblemsProblemImagesOnProblem.fromJson(e))
        .toList();
  @override
  bool operator ==(Object other) {
    ...
    final MaxUpvoteProblemProblems otherTyped = other as MaxUpvoteProblemProblems;
...
@immutable
class MaxUpvoteProblemProblemsProblemType {
  final String typeName;
  final String typeThaiName;
  MaxUpvoteProblemProblemsProblemType.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final MaxUpvoteProblemProblemsProblemType otherTyped = other as MaxUpvoteProblemProblemsProblemType;
  ...
  MaxUpvoteProblemProblemsProblemType({
...
@immutable
class MaxUpvoteProblemProblemsCurrentTags {
  final String tagName;
  final String tagThaiName;
  MaxUpvoteProblemProblemsCurrentTags.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final MaxUpvoteProblemProblemsCurrentTags otherTyped = other as MaxUpvoteProblemProblemsCurrentTags;
  ...
  MaxUpvoteProblemProblemsCurrentTags({
...
@immutable
class MaxUpvoteProblemProblemsUserUpvotesOnProblem {
  final String userId;
  MaxUpvoteProblemProblemsUserUpvotesOnProblem.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final MaxUpvoteProblemProblemsUserUpvotesOnProblem otherTyped = other as MaxUpvoteProblemProblemsUserUpvotesOnProblem;
  ...
  MaxUpvoteProblemProblemsUserUpvotesOnProblem({
    required this.userId,
  });
}

@immutable
class MaxUpvoteProblemProblemsProblemImagesOnProblem {
  final String imageUrl;
  final String fileName;
  final String imageType;
  MaxUpvoteProblemProblemsProblemImagesOnProblem.fromJson(dynamic json):
  ...
  bool operator ==(Object other) {
    ...
    final MaxUpvoteProblemProblemsProblemImagesOnProblem otherTyped = other as MaxUpvoteProblemProblemsProblemImagesOnProblem;
  ...
  MaxUpvoteProblemProblemsProblemImagesOnProblem({
...
@immutable
class MaxUpvoteProblemData {
  final List<MaxUpvoteProblemProblems> problems;
  MaxUpvoteProblemData.fromJson(dynamic json):
  
  problems = (json['problems'] as List<dynamic>)
        .map((e) => MaxUpvoteProblemProblems.fromJson(e))
        .toList();
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
    ...
    final MaxUpvoteProblemData otherTyped = other as MaxUpvoteProblemData;
